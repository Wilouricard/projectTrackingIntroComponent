...
export default function Navbar() {
  return (
    <nav className="flex pt-5 absolute w-full">
      <div className="bg-white flex flex-col text-center mr-auto ml-auto w-3/4 py-6 uppercase tracking-widest gap-5 font-bold text-xl shadow-lg rounded-lg">
